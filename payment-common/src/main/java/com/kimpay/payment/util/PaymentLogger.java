...
public class PaymentLogger {
    ...
    public static @NotNull PaymentLogger getLogger(Class<?> clazz) {
    ...
    @Contract(pure = true)
    private @NotNull String formatMessage(String message) {
        return String.format("[%s] %s", className, message);
    }

    private @NotNull String maskSensitiveData(String data) {
